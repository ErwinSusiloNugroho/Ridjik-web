...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 09, 2025 at 05:55 AM
...
INSERT INTO `bahan` (`id_bahan`, `kode_bahan`, `nama_bahan`, `nama_suppliyer`, `stok_bahan`, `harga`) VALUES
(0, 43155, 'sabun air', 'sandi', 712, 6000),
(1, 12345, 'gliserin', 'toko abc', 5, 50000),
(2, 23456, 'alkohol murni', 'toko def', 6, 50000),
(3, 82005, 'sabun basah', 'datasari', 12, 9000),
(4, 13802, 'sampo', 'daka', 17, 7000),
(5, 25315, 'sampo', 'daka', 17, 7000);
...
(1, 9, '1. ad', '1. ad', '2025-06-05 12:19:39', '2025-06-05 12:19:39'),
...
(8, 43, '1. ada', '1. da', '2025-06-05 18:15:30', '2025-06-05 18:15:30'),
...
(14, 45, '1. kln', '1. \',.m', '2025-06-06 06:43:44', '2025-06-06 06:43:44');
...
INSERT INTO `transaksi` (`id_transaksi`, `jenis`, `tanggal`, `nota`) VALUES
(1, 'pembelian', '2025-05-27', ''),
(2, 'penjualan', '2025-05-27', ''),
(3, 'penjualan', '2025-05-27', ''),
(4, 'penjualan', '2025-05-27', ''),
(5, 'pembelian', '2025-05-27', ''),
(6, 'pembelian', '2025-05-30', '');
