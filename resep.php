        ...
        <div id="modalTambah" class="modal-bg hidden">
            <div class="modal-content max-w-lg">
                ...
                <form method="POST" action="simpan_resep.php" id="formTambahResep">
                    ...
                    <label class="block mb-2 font-semibold" for="bahanResep">Bahan-bahan (NO otomatis jika enter)</label>
...
<script>
    ...
    // Set id_produk dan kode_produk otomatis saat memilih produk dari datalist
        ...
        const val = namaProdukInput.value.trim().toLowerCase();
        const found = produkOptions.find(p => p.nama_produk.toLowerCase() === val);
        if (found) {
            idProdukInput.value = found.id_produk;
            kodeProdukInput.value = found.kode_produk;
            kodeProdukInput.classList.remove('bg-gray-100'); // agar terlihat interaktif
